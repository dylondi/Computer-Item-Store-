...
import com.server.side.persistence.Writer;
...
public class AnalyserIntegrationTestWithDB {
    ...
    static List<ComputerComponent> returnedMap;
    static Inventory inventoryDB;
    static Writer writer;
    static EntityManagerFactory factory;
    static EntityManager entityManager;
    static Map<UUID, ComputerComponent> map;
    ...
    public static void setUp() throws IOException {
        ...
        map = inMemDbGenerator.createInMemDb(inventoryParser.createObjects(parsedCSV));
        ...
        returnedMap = getDataFromDB(entityManager);
        inventoryDB = new Inventory(inMemDbGenerator.createInMemDb(returnedMap));
